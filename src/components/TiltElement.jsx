...
function TiltElement( { glareEnable } ) {
  ...
  >
    ...
    <div className='absolute left-0 top-0 h-full w-full bg-background-900 bg-opacity-80'>
      <div className='flex h-full items-center justify-center inner-element'>
        <div className='font-bold text-xl text-center text-primary-300 md:text-2xl transition-all ease-in-out duration-300 group-hover:text-2xl'>Banger</div>
      </div>
    </div>
