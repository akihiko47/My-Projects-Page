...
function Hero() {
  ...
  return (
    <div className='flex p-4 flex-col text-center w-full h-[80vh] min-h-[700px] max-h-[1000px] max-w-[400px] mx-auto justify-center md:max-w-[1200px] md:p-10'>
        ...
        <button type='button' onClick={scrollToProjects} className='transition-all ease-in-out duration-200 uppercase bg-primary-300 px-6 py-3 rounded-md mx-auto font-bold mt-14 hover:rounded-3xl hover:bg-primary-200 hover:shadow-md hover:shadow-primary-300 hover:-translate-y-2 md:ml-0 md:mt-8'>view projects</button>
    </div>
